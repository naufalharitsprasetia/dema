...
<div class="departement-section text-primary">
    ...
    <div class="departement max-w-7xl mx-auto py-16 px-10">
        ...
        <div class="members-departement flex flex-wrap justify-center gap-8">
            ...
            <div class="member-card group w-56 h-80 perspective">
                <div class="card-inner relative w-full h-full transition-transform duration-700 transform group-hover:rotate-y-180">
                    {{-- Front Side --}}
                    ...
                    {{-- Back Side --}}
                    <div class="back-card absolute w-full h-full bg-secondary p-3 text-center backface-hidden transform rotate-y-180 flex flex-col items-center justify-center">
