    ...
    <div class="mx-4 md:mx-6 lg:mx-16 bg-slate-200 p-4 md:p-8  rounded-lg shadow-lg">
        ...
        <form action="/ukm-edit/{{ $uKM->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama" name="nama" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('nama', $uKM->nama) }}" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="deskripsi" name="deskripsi" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('deskripsi', $uKM->deskripsi) }}">
            </div>

            <div class="mb-4">
                <label for="logo" class="block text-gray-700 font-bold mb-2">Logo UKM (Max:5MB):</label>
                <input type="file" id="logo" name="logo" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>

            <div class="mb-4">
                <label for="jumlah_anggota" class="block text-gray-700 font-bold mb-2">Jumlah Anggota UKM :</label>
                <input type="text" id="jumlah_anggota" name="jumlah_anggota" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('jumlah_anggota', $uKM->jumlah_anggota) }}">
            </div>

            <div class="mb-4">
                <label for="link_sosmed" class="block text-gray-700 font-bold mb-2">Link Sosial Media :</label>
                <input type="text" id="link_sosmed" name="link_sosmed" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('link_sosmed', $uKM->link_sosmed) }}">
            </div>
