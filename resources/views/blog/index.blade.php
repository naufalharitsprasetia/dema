...
@section('content')
{{-- Artikel Index --}}
<div class="artikel-section min-h-screen overflow-hidden relative isolate z-10 text-primary">
    <x-efek.glowatas />
    <x-efek.glowbawah />
        ...
        <div class="max-w-7xl px-12 pt-4 pb-12 mx-auto w-full flex flex-wrap justify-center items-center">
            ...
            <a class="p-2" href="/blog/{{ $blog->id }}">
                <div class="relative overflow-hidden rounded-lg card-artikel text-center">
                    ...
                    <div
                        class="absolute bottom-0 left-0 right-0 p-4 bg-linear-to-t from-black to-transparent text-white">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="/blog/{{ $beritaUtama1->id }}" class="relative col-span-2 row-span-2 overflow-hidden rounded-lg">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-4 bg-linear-to-t from-black to-transparent text-white">
